...
const Login: FunctionComponent = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Print exactly what is being sent to backend (temporary)
      ...
      // The backend returns LoginResponse with access_token
      console.log("[Login] backend response:", res.status, res.data);

      if (res.data?.access_token) {
        localStorage.setItem("access_token", res.data.access_token);
      }

      // Existing dashboard routing expects /dashboard
      navigate("/dashboard");
    } catch (err: any) {
      console.log("[Login] axios error payload:", err?.response?.data);
      ...
      const msg = detail || fallback || "Email atau kata sandi salah";
      setError(msg);
      alert(msg);
    } finally {
      setIsLoading(false);
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <section className="self-stretch flex flex-col items-start py-0 gap-[3px] mb-8 z-[1] shrink-0 text-left text-[30px] text-foundation-grey-dark font-['SF Pro Display']">
                <div className="self-stretch flex flex-col items-start gap-0">
                  <h1 className="m-0 w-[640px] h-[35px] relative text-[length:inherit] font-normal font-[inherit] inline-block">
                    Satu Data,
                  </h1>
                  <h2 className="m-0 w-[640px] h-[45px] relative text-[30px] font-bold font-[inherit] text-foundation-blue-normal-hover inline-block">
                    Satu Keputusan.
                  </h2>
                </div>
                ...
                <div className="self-stretch relative text-[13px] leading-[1.]">
                  ...
                  <br />akademik dan institusi secara realtime, akurat dan
                  <br />efisien
                </div>
              </section>
              ...
              <>
                ...
                <div className="text-center mb-1">
                  ...
                  <p className="text-[#a5a5a5] text-[15px] leading-[1.2] mt-0">
                    Login untuk mengakses Dashboard Satu Data Perguruan Tinggi
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="rounded-[8px] bg-[#dce7ff] px-3 py-2 flex items-start gap-2">
                    ...
                    <p className="text-[11px] text-[#2b2b2b] leading-[1.3] m-0">
                      Silahkan cek inbox atau Spam jika instruksi tidak ditemukan
                    </p>
                  </div>
