...
const SummaryCard = ({
  ...
  return (
    <div className="flex h-[82px] items-center gap-3 rounded-[10px] bg-white px-4">
      <div
...
const DashboardSistem = () => {
  ...
  return (
    ...
    >
      ...
      <section className="mt-[14px] rounded-[12px] bg-white px-[24px] pb-[24px] pt-[12px] shadow-[0_8px_18px_rgba(15,23,42,0.04)]">
                ...
                <tbody>
                  ...
                  {!isLoading && filteredUsers.length === 0 && (
                    <tr>
                      <td
                        colSpan={6}
                        className="py-10 text-center text-[13px] text-[#94A3B8]"
                      >
              ...
              <div className="flex flex-col gap-[10px]">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "Akses pimpinan",
                    users: 5,
                    color: "bg-[#FFE7E7] text-[#EF4444]",
                  },
                  {
                    code: "BA",
                    name: "Biro Akademik",
                    desc: "Kelola data akademik",
                    users: 12,
                    color: "bg-[#EEE7FF] text-[#7C3AED]",
                  },
                  {
                    code: "UM",
                    name: "Unit Jaminan Mutu",
                    desc: "Monitoring & evaluasi",
                    users: 6,
                  ...
                  >
                    <div
                      className={`flex h-[38px] w-[38px] items-center justify-center rounded-[8px] text-[13px] font-semibold ${role.color}`}
                    >
                      {role.code}
                    </div>
              ...
              <table className="w-full border-collapse">
                ...
                <tbody>
                  {[
                    ...
                    <>
                      <tr key={group.group} className="bg-[#F8FAFC]">
                ...
                <tbody>
                  {[
                    ...
                    >
                      ...
                      <td>
                        <span
                          className={`rounded-full px-[8px] py-[3px] text-[9px] font-semibold ${
                            item.color === "green"
                  ...
                  <div key={log.title} className="flex items-start gap-[12px]">
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between gap-[8px]">
                        ...
                        <span
                          className={`shrink-0 rounded-full px-[8px] py-[3px] text-[8px] font-semibold ${
                            log.color === "red"
                              ? "bg-[#FFE7E7] text-[#EF4444]"
                              : log.color === "yellow"
          ...
          <div className="grid grid-cols-4 gap-[14px]">
            {[
              ...
              <div
                ...
                <span
                  className={`inline-block rounded-[4px] px-[8px] py-[3px] text-[9px] font-semibold ${
                    item.color === "green"
                      ? "bg-[#DCFCE7] text-[#16A34A]"
                      : item.color === "yellow"
                      ? "bg-[#FFF4D8] text-[#F59E0B]"
                ...
                <div className="mt-[12px] flex items-center justify-between">
                  <button
                    className={`h-[28px] rounded-[5px] px-[12px] text-[10px] font-medium ${
                      item.button === "Hubungkan"
