...
- **FR-AUTH-01**: Pengguna dapat melakukan login menggunakan email/username dan kata sandi.
- **FR-AUTH-02**: Sistem memvalidasi kredensial menggunakan token JWT (*JSON Web Token*).
- **FR-AUTH-03**: Pengguna dapat melihat dan mengelola profil akun ([Profil.tsx](file:///home/akbarydhh/Downloads/datains-capstone/frontend/src/pages/Profil.tsx)).
- **FR-AUTH-04**: Pengguna dapat melakukan reset kata sandi ([ResetPassword.tsx](file:///home/akbarydhh/Downloads/datains-capstone/frontend/src/pages/ResetPassword.tsx)).

### 4.2 Modul Dashboard Analytics
...
### 4.3 Modul Chatbot AI & BI Integration
